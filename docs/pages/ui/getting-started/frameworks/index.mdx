...
Tabler is framework-agnostic: it styles standard HTML, so it works with any stack that renders markup. Each guide below shows the fastest path to a working Tabler page â€” installing `@firstcrop/core`, wiring the styles and scripts where your framework expects them, and rendering a first component.
