...
icon: diamond
seoDescription: Install `@firstcrop/core`, load CSS and optional JS in Rails, and render a minimal page layout with a Tabler card.
...
You will install `@firstcrop/core`, import its assets in your application bundles, and render a first view with a Tabler card.
