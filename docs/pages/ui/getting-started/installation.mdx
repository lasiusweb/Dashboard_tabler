...
title: Installation
order: 1
summary: Learn how to set up Tabler in your project by creating a basic HTML file, adding Tablerâ€™s CSS and JavaScript, and exploring its powerful components to build responsive and visually stunning web applications.
...
This guide will take you through the essential steps to set up Tabler in your project, from creating a basic HTML file to incorporating Tablerâ€™s styles and scripts. Letâ€™s dive in!
...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Tabler Demo</title>
    <link rel="stylesheet" href="${site.cdnUrl}/dist/css/firstcrop.min.css" />
  </head>
  <body>
    <h1>Hello, Tabler!</h1>
    <script src="${site.cdnUrl}/dist/js/firstcrop.min.js"></script>
  </body>
</html>`}
/>
