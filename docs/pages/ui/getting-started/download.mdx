...
All files included in the `@firstcrop/core` npm package are available over a jsDelivr CDN. Use it to deliver cached versions of Tablerâ€™s compiled CSS and JS to your project.
